...
def run():
    ...
    name = raw_input("What is your name? ") # saves player's name in the 'name' variable
    raw_input("Press ENTER on the keyboard when ready") # waits for player to press the enter key
